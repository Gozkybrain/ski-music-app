...
const HipHop = () => {
  ...
  const fetchPopSongs = async () => {
    try {
      const response = await axios.get(`http://ws.audioscrobbler.com/2.0/?method=tag.gettoptracks&tag=hiphop&api_key=${LASTFM_API_KEY}&format=json`);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.genreCard}>
        <Image source={require('../../assets/chris.png')} style={styles.genreImage} />
        <View style={styles.bg}> 
          <Text style={styles.genreCardText}>Hip Hop</Text>
        </View>
      </View>
