...
const Country = () => {
  ...
  const fetchPopSongs = async () => {
    try {
      const response = await axios.get(`http://ws.audioscrobbler.com/2.0/?method=tag.gettoptracks&tag=country&api_key=${LASTFM_API_KEY}&format=json`);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.genreCard}>
        <Image source={require('../../assets/country.png')} style={styles.genreImage} />
